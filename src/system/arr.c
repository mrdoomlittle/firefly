...
# include "err.h"
ffly_err_t ffly_arr_init(ffly_arrp __arr, mdl_uint_t __blk_size, mdl_uint_t __blk_c) {
...
ffly_err_t ffly_arr_resize(ffly_arrp __arr, mdl_uint_t __blk_c) {
...
void* ffly_arr_get(ffly_arrp __arr, ffly_off_t __blk_off) {
	return (void*)((mdl_u8_t*)__arr->p+(__blk_off*__arr->blk_size));}

void ffly_arr_put(ffly_arrp __arr, void *__p, ffly_off_t __blk_off) {
	ffly_mem_cpy((void*)((mdl_u8_t*)__arr->p+(__blk_off*__arr->blk_size)), __p, __arr->blk_size);}

ffly_err_t ffly_arr_de_init(ffly_arrp __arr) {
	if (__arr->p != NULL) {
