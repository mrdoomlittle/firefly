...
# define ffly_pipe_rd8l(__pipe) \
    ffly_pipe_rdl(1, __pipe)
# define ffly_pipe_rd16l(__pipe) \
    ffly_pipe_rdl(2, __pipe)
# define ffly_pipe_rd32l(__pipe) \
    ffly_pipe_rdl(4, __pipe)
# define ffly_pipe_rd64l(__pipe) \
    ffly_pipe_rdl(8, __pipe)

void ffly_pipe_wrl(mdl_u64_t, mdl_u8_t, mdl_uint_t);
mdl_u64_t ffly_pipe_rdl(mdl_u8_t, mdl_uint_t);
