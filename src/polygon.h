...
void ffly_draw_polygon(ffly_polygonp, ffly_byte_t*, ffly_byte_t*, mdl_uint_t, mdl_uint_t, mdl_uint_t, mdl_uint_t, mdl_uint_t, mdl_uint_t, mdl_uint_t, mdl_uint_t, float);
