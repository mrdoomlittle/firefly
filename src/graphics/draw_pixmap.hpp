...
# endif
# include "../types/gpu_dr_pm_mem_t.hpp"
namespace mdl {
namespace firefly {
namespace graphics {
...
types::err_t gpu_draw_pixmap(types::gpu_dr_pm_mem_t& __gpu_dr_pm_mem, uint_t __xfs, uint_t __yfs, types::pixmap_t __pixbuff, uint_t __pb_xlen, uint_t __pb_ylen, uint_t __pm_xfs, types::pixmap_t __pixmap, uint_t __pm_xlen, uint_t __pm_ylen, uint_t __rpm_xlen, boost::uint16_t __angle = 0);
# endif
# ifndef __NVCC__
types::err_t draw_pixmap(types::gpu_dr_pm_mem_t& __gpu_dr_pm_mem, uint_t __xfs, uint_t __yfs, types::pixmap_t __pixbuff, uint_t __pb_xlen, uint_t __pb_ylen, types::pixmap_t __pixmap, uint_t __pm_xlen, uint_t __pm_ylen, boost::uint16_t __angle = 0);
