...
types::err_t gpu_crop_2d_pm(uint_t __xfs, uint_t __yfs, types::_2d_pm_t __pixbuff, uint_t __pb_xlen, uint_t __pb_ylen, types::_2d_pm_t __pixmap, uint_t __pm_xlen, uint_t __pm_ylen, u8_t __chn_c);
...
# endif
types::err_t static crop_2d_pm(uint_t __xfs, uint_t __yfs, types::_2d_pm_t __pixbuff, uint_t __pb_xlen, uint_t __pb_ylen, types::_2d_pm_t __pixmap, uint_t __pm_xlen, uint_t __pm_ylen, u8_t __chn_c) {
	return gpu_crop_2d_pm(__xfs, __yfs, __pixbuff, __pb_xlen, __pb_ylen, __pixmap, __pm_xlen, __pm_ylen, __chn_c);
}
