...
ff_err_t ff_db_ctr_creat_pile(ff_db_ctrp, ff_uint_t*);
ff_err_t ff_db_ctr_del_pile(ff_db_ctrp, ff_uint_t);
ff_err_t ff_db_ctr_creat_record(ff_db_ctrp, ff_uint_t, ff_uint_t*, ff_uint_t);
ff_err_t ff_db_ctr_del_record(ff_db_ctrp, ff_uint_t, ff_uint_t);
ff_err_t ff_db_ctr_write(ff_db_ctrp, ff_uint_t, ff_uint_t, ff_u32_t, void*, ff_uint_t);
ff_err_t ff_db_ctr_read(ff_db_ctrp, ff_uint_t, ff_uint_t, ff_u32_t, void*, ff_uint_t);
ff_err_t ff_db_ctr_record_alloc(ff_db_ctrp, ff_uint_t);
ff_err_t ff_db_ctr_record_free(ff_db_ctrp, ff_uint_t);
ff_err_t ff_db_ctr_rivet(ff_db_ctrp, ff_u16_t, ff_uint_t);
ff_err_t ff_db_ctr_derivet(ff_db_ctrp, ff_u16_t);
ff_err_t ff_db_ctr_rivetto(ff_db_ctrp, ff_u16_t, ff_uint_t);
ff_err_t ff_db_ctr_bind(ff_db_ctrp, ff_u16_t, ff_uint_t, ff_u8_t);
