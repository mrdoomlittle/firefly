...
class btn_manager {
	public:
	btn_manager(types::pixmap_t __pixbuff, types::coords_t *__wd_coords, types::coords_t *__mouse_coords, boost::uint16_t __pb_xaxis_len, boost::uint16_t __pb_yaxis_len)
	...
	types::coords_t *wd_coords, *mouse_coords;
