...
ffly_err_t ffly_camera_handle(ffly_camerap __camera) {
    ffly_mem_set(__camera->pixels, 0x0, __camera->width*__camera->height*4);
    ffly_uni_frame(__camera->uni, __camera->pixels, __camera->width, __camera->height, 1, __camera->xa, __camera->ya, 0);
}
