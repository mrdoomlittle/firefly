...
dst_dir=$root_dir
cd ../ && . ./compile.sh && cd as
ffly_objs="$ffly_objs local.o remf.o elf.o symbol.o stt.o output.o opcodes/resin_tbl.o opcodes/amd64_tbl.o output/resin.o output/amd64.o as.o hash.o alloca.o parser.o exp.o frag.o"
