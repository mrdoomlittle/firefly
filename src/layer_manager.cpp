...
mdl::i8_t mdl::firefly::layer_manager::push_forwards(uint_t __layer_id) {
...
mdl::i8_t mdl::firefly::layer_manager::pull_backwards(uint_t __layer_id) {
	if (this->locked_layer(__layer_id)) return FFLY_NOP;
...
mdl::i8_t mdl::firefly::layer_manager::swap(uint_t __layer_ida, uint_t __layer_idb) {
