...
// ignore this
__inline__ static types::_1d_pm_t alloc_pixmap(uint_t __xa_len, u8_t __chn_c = 4) {
	return alloc_pixmap(__xa_len, 1, 1, __chn_c);
}

__inline__ static types::_1d_pm_t alloc_pixmap(uint_t __xa_len, uint_t __ya_len, u8_t __chn_c = 4) {
...
__inline__ static types::_1d_pm_t alloc_pixmap(types::_3d_dsize_t<> __dsize, u8_t __chn_c = 4) {
