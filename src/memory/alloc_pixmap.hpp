...
__inline__ types::_2d_pm_t make_2d_pm(types::_1d_pm_t __1d_pm, uint_t __xa_len, uint_t __ya_len, u8_t __chn_c = 4) {
	types::_2d_pm_t _2d_pm = (types::_2d_pm_t)mem_alloc(__ya_len  * sizeof(types::_1d_pm_t));
	for (uint_t ya{}; ya != __ya_len; ya ++) _2d_pm[ya] = __1d_pm + (ya * (__chn_c * __xa_len));
	return _2d_pm;
}

__inline__ types::_3d_pm_t make_3d_pm(types::_1d_pm_t __1d_pm, uint_t __xa_len, uint_t __ya_len, uint_t __za_len, u8_t __chn_c = 4) {
	...
	for (uint_t za{}; za != __za_len; za ++) {
		...
		for (uint_t ya{}; ya != __ya_len; ya ++) _3d_pm[za][ya] = __1d_pm + ((za * (__chn_c * (__xa_len * __ya_len))) + (ya * (__xa_len * __chn_c)));
	}
	return _3d_pm;
}
