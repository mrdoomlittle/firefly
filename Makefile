...
ifeq ($(shell bash find.bash "$(ffly_flags)" "--with-room-manager"), 0)
 override ffly_objs+= src/room_manager.o
endif

ifeq ($(shell bash find.bash "$(ffly_flags)" "--with-uni-manager"), 0)
 override ffly_objs+= src/uni_manager.o src/chunk_manager.o src/chunk_keeper.o src/data/uni_dlen_val.o
endif

ifeq ($(shell bash find.bash "$(ffly_flags)" "--with-obj-manager"), 0)
 override ffly_objs+= src/obj_manager.o
endif
...
src/system/mem_blk.o: src/system/mem_blk.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/mem_blk.o src/system/mem_blk.c

src/system/task_pool.o: src/system/task_pool.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/task_pool.o src/system/task_pool.c

src/system/task_worker.o: src/system/task_worker.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/task_worker.o src/system/task_worker.c

src/system/file.o: src/system/file.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/file.o src/system/file.c

src/system/dir.o: src/system/dir.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/dir.o src/system/dir.c

src/chunk_keeper.o:src/chunk_keeper.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/chunk_keeper.o src/chunk_keeper.c

src/data/str_cmp.o: src/data/str_cmp.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/str_cmp.o src/data/str_cmp.c

src/data/mem_cmp.o: src/data/mem_cmp.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/mem_cmp.o src/data/mem_cmp.c

src/data/str_dupe.o: src/data/str_dupe.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/str_dupe.o src/data/str_dupe.c

src/system/util/hash.o: src/system/util/hash.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/util/hash.o src/system/util/hash.c

src/system/map.o: src/system/map.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/map.o src/system/map.c

src/audio/alsa.o: src/audio/alsa.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/audio/alsa.o src/audio/alsa.c

src/audio/pulse.o: src/audio/pulse.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/audio/pulse.o src/audio/pulse.c

src/system/flags.o: src/system/flags.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/flags.o src/system/flags.c

src/system/thread.o: src/system/thread.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=gnu11 -D$(ffly_target) $(ffly_defines) -o src/system/thread.o src/system/thread.c
...
src/ffly_graphics.o: src/ffly_graphics.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_graphics.o src/ffly_graphics.cpp
...
src/system/buff.o: src/system/buff.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/buff.o src/system/buff.c

src/system/vec.o: src/system/vec.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/vec.o src/system/vec.c

src/data/swp.o: src/data/swp.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/swp.o src/data/swp.c

src/data/mem_set.o: src/data/mem_set.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/mem_set.o src/data/mem_set.c

src/data/mem_cpy.o: src/data/mem_cpy.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/mem_cpy.o src/data/mem_cpy.c

src/data/str_len.o: src/data/str_len.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/str_len.o src/data/str_len.c

src/data/mem_dupe.o: src/data/mem_dupe.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/data/mem_dupe.o src/data/mem_dupe.c

src/system/time.o: src/system/time.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=gnu11 -D$(ffly_target) $(ffly_defines) -o src/system/time.o src/system/time.c

src/system/io.o: src/system/io.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/io.o src/system/io.c

src/system/smem_buff.o: src/system/smem_buff.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/smem_buff.o src/system/smem_buff.c

src/system/config.o: src/system/config.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/system/config.o src/system/config.cpp

src/system/errno.o: src/system/errno.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/system/errno.o src/system/errno.c

src/skel_creator.o: src/skel_creator.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/skel_creator.o src/skel_creator.cpp

src/data/uni_dlen_val.o: src/data/uni_dlen_val.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/data/uni_dlen_val.o src/data/uni_dlen_val.cpp

src/graphics/draw_grid.o: src/graphics/draw_grid.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/draw_grid.o src/graphics/draw_grid.cpp
...
src/alsa_audio.o: src/alsa_audio.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/alsa_audio.o src/alsa_audio.cpp

src/entity_manager.o: src/entity_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/entity_manager.o src/entity_manager.cpp

src/ui/camera.o: src/ui/camera.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ui/camera.o src/ui/camera.cpp

src/graphics/crop_pixmap.o: src/graphics/crop_pixmap.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/crop_pixmap.o src/graphics/crop_pixmap.cu

src/firefly.o: src/firefly.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/firefly.o src/firefly.cpp

src/uni_manager.o: src/uni_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/uni_manager.o src/uni_manager.cpp

src/chunk_manager.o: src/chunk_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/chunk_manager.o src/chunk_manager.cpp

#src/system/task_handle.o: src/system/task_handle.cpp
#	$(ffly_cxx) -c -Wall -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/system/task_handle.o src/system/task_handle.cpp

#src/system/task_worker.o: src/system/task_worker.cpp
#	$(ffly_cxx) -c -Wall -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/system/task_worker.o src/system/task_worker.cpp

src/graphics/x11_wd.o: src/graphics/x11_wd.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_cflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/graphics/x11_wd.o src/graphics/x11_wd.c

src/graphics/png_loader.o: src/graphics/png_loader.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/png_loader.o src/graphics/png_loader.cpp

src/networking/tcp_server.o: src/networking/tcp_server.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/networking/tcp_server.o src/networking/tcp_server.cpp

src/networking/tcp_client.o: src/networking/tcp_client.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/networking/tcp_client.o src/networking/tcp_client.cpp

src/networking/udp_server.o: src/networking/udp_server.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/networking/udp_server.o src/networking/udp_server.cpp

src/networking/udp_client.o: src/networking/udp_client.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/networking/udp_client.o src/networking/udp_client.cpp

src/ffly_worker.o: src/uni_worker.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_worker.o src/uni_worker.cpp

src/ffly_server.o: src/ffly_server.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_server.o src/ffly_server.cpp

src/ffly_client.o: src/ffly_client.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_client.o src/ffly_client.cpp

src/cuda_helper.o: src/cuda_helper.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/cuda_helper.o src/cuda_helper.cpp

src/graphics/draw_rect.o: src/graphics/draw_rect.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/draw_rect.o src/graphics/draw_rect.cu

src/graphics/draw_skelmap.o: src/graphics/draw_skelmap.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/draw_skelmap.o src/graphics/draw_skelmap.cu

src/graphics/skelmap_loader.o: src/graphics/skelmap_loader.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/skelmap_loader.o src/graphics/skelmap_loader.cpp

src/asset_manager.o: src/asset_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/asset_manager.o src/asset_manager.cpp
...
src/graphics/fill_pixmap.o: src/graphics/fill_pixmap.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/fill_pixmap.o src/graphics/fill_pixmap.cu

src/tests/layering.o: src/tests/layering.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/tests/layering.o src/tests/layering.cpp

src/maths/rotate_point.o: src/maths/rotate_point.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/maths/rotate_point.o src/maths/rotate_point.cpp

src/graphics/scale_pixmap.o: src/graphics/scale_pixmap.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/scale_pixmap.o src/graphics/scale_pixmap.cu

src/opencl_helper.o: src/opencl_helper.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/opencl_helper.o src/opencl_helper.cpp

src/worker_manager.o: src/worker_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/worker_manager.o src/worker_manager.cpp

src/memory/alloc_pixelmap.o: src/memory/alloc_pixelmap.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/memory/alloc_pixelmap.o src/memory/alloc_pixelmap.c
...
src/obj_manager.o: src/obj_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/obj_manager.o src/obj_manager.cpp

src/maths/cal_dist.o: src/maths/cal_dist.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/maths/cal_dist.o src/maths/cal_dist.cpp

src/gravy_manager.o: src/gravy_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/gravy_manager.o src/gravy_manager.cpp

src/ffly_studio.o: src/ffly_studio.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_studio.o src/ffly_studio.cpp

src/ffly_test.o: src/ffly_test.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/ffly_test.o src/ffly_test.cpp

src/gui/btn_manager.o: src/gui/btn_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/gui/btn_manager.o src/gui/btn_manager.cpp

src/graphics/draw_bitmap.o: src/graphics/draw_bitmap.cu
	$(ffly_nvcc) -c -std=c++11 $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/graphics/draw_bitmap.o src/graphics/draw_bitmap.cu

src/pulse_audio.o: src/pulse_audio.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/pulse_audio.o src/pulse_audio.cpp

src/graphics/xcb_wd.o: src/graphics/xcb_wd.c
	$(ffly_cc) -c $(ffly_cflags) $(ffly_ccflags) -std=$(ffly_stdc) -D$(ffly_target) $(ffly_defines) -o src/graphics/xcb_wd.o src/graphics/xcb_wd.c

src/room_manager.o: src/room_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/room_manager.o src/room_manager.cpp

src/system/time_stamp.o: src/system/time_stamp.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/system/time_stamp.o src/system/time_stamp.cpp

src/gui/wd_frame.o: src/gui/wd_frame.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/gui/wd_frame.o src/gui/wd_frame.cpp

src/gui/window.o: src/gui/window.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/gui/window.o src/gui/window.cpp

src/system/event.o: src/system/event.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/system/event.o src/system/event.cpp

src/data/scale_pixmap.o: src/data/scale_pixmap.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/data/scale_pixmap.o src/data/scale_pixmap.cpp

src/font.o: src/font.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/font.o src/font.cpp

src/player_manager.o: src/player_manager.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/player_manager.o src/player_manager.cpp

src/player_handler.o: src/player_handler.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/player_handler.o src/player_handler.cpp

src/worker_handler.o: src/worker_handler.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/worker_handler.o src/worker_handler.cpp

src/uni_worker.o: src/uni_worker.cpp
	$(ffly_cxx) -c $(ffly_cflags) $(ffly_cxxflags) -std=$(ffly_stdcxx) $(CXX_IFLAGS) -D$(ffly_target) $(ffly_defines) -o src/uni_worker.o src/uni_worker.cpp
